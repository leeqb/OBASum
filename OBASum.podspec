#
#  Be sure to run `pod spec lint OBASum.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "公共基础类库"

  s.homepage     = "https://github.com/leeqb/OBASum"
  ...
  s.author             = { "xboy" => "dolphin2525@163.com" }
  # Or just: s.author    = "xboy"
  # s.authors            = { "xboy" => "dolphin2525@163.com" }
  # s.social_media_url   = "http://twitter.com/xboy"
